        ...
        <div className="fixed inset-0 flex items-center justify-center bg-black/70 backdrop-blur-sm z-50 p-4">
          <div className="bg-slate-900 border border-slate-800 p-6 rounded-2xl shadow-2xl w-full max-w-md text-slate-100">
            <div className="flex justify-between items-center mb-6">
              <h2 className="text-lg font-bold tracking-tight uppercase text-slate-200">Meeting Room Ready</h2>
              <button
            ...
            <p className="text-xs font-semibold text-slate-400 mb-2 uppercase tracking-wider">Share this Room ID with participants</p>
